...
class TaskTestCase(B2LuigiTestCase):
    def test_file_path_usage(self):
        ...
        self.assertEqual(task.get_output_target("file_a").path, task.get_output_file_name("file_a"))
    ...
    def test_dependencies(self):
        ...
        self.assertEqual(task.get_output_target("file_b").path, task.get_output_file_name("file_b"))
        self.assertIn("file_b", task.get_output_file_name("file_b"))
